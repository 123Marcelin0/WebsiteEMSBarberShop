...
export const metadata = {
  title: "Impressum | EMS Barbershop Lingen",
  description: "Impressum und rechtliche Informationen von EMS Barbershop Lingen",
}
  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <h1 className="text-4xl font-bold text-gold mb-12">Impressum</h1>
