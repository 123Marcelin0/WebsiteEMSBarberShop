      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          >
            ...
            <div className="absolute inset-0 border-2 border-transparent group-hover:border-gold/30 transition-colors duration-500 rounded-lg pointer-events-none z-10" />
          </div>
          ...
          >
            ...
            <div className="relative p-8 lg:p-12 flex flex-col justify-center h-full min-h-[500px]">
              ...
              <h2
                className={`font-heading text-3xl lg:text-4xl xl:text-5xl font-bold text-gold mb-6 leading-tight animate-initial ${isVisible ? "animate-fade-up delay-400" : ""}`}
              >
                MEHR ALS NUR
                <br />
                EIN HAARSCHNITT
              ...
              >
                ...
                <span className="text-gold/60 text-xs tracking-widest">SEIT 2024</span>
              </div>
            </div>
          </div>
        </div>
