          ...
          <div className="flex-shrink-0">
            ...
            >
              ...
              <div className="relative h-6 min-w-[160px]">
                ...
                <span
                  className={`absolute left-0 top-0 text-base font-semibold tracking-wide text-foreground whitespace-nowrap transition-all duration-400 ease-out ${isHovered ? "opacity-0 -translate-x-2" : "opacity-100 translate-x-0"
                    } ${isLoaded ? "translate-y-0" : "-translate-y-4"}`}
                >
                  <span className="text-gold font-bold">Ems</span>
                  <span className="font-light text-foreground/90"> Barber Shop</span>
                </span>
