  ...
  return (
    <section id="home" className="min-h-[100svh] flex flex-col pt-20 relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full relative z-10 flex-1 flex flex-col">
        <div className="flex flex-col items-center text-center pt-24 lg:pt-20">
          <div
          ...
          >
            <Scissors className="w-3 h-3 text-gold animate-pulse" />
        ...
        <div className="flex-1 flex flex-col items-center justify-end pb-12 lg:pb-16">
          ...
          <div className={`flex items-center gap-4 animate-initial ${isVisible ? "animate-fade-in delay-400" : ""}`}>
            ...
            <span className="text-xs tracking-widest text-gray-300 uppercase">Seit 2024</span>
